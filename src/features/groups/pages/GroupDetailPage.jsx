            ...
            {!inviteUrl ? (
              ...
              <div className="relative group overflow-hidden rounded-[1.5rem] bg-surface-muted border border-border/50 p-1.5 flex items-center transition-all hover:border-primary/30 animate-in slide-in-from-bottom-2 duration-300">
                ...
                <div className="flex gap-1.5">
                  ...
                  <a
                    href={`https://wa.me/?text=${encodeURIComponent(`¡Únete como cómplice en Surpry! ${inviteUrl}`)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex size-11 items-center justify-center rounded-2xl bg-success text-white hover:bg-success/80 transition-all active:scale-90"
                  >
